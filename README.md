...
### Pick a One Word Per Concept

The idea is to choose a single word or phrase that accurately and succinctly represents the concept or meaning of the variable, function, or class, and then use that same word consistently throughout the codebase.
...
Puns mean words that have multiple meanings, These puns can make your code hard to read and understand, So to solve this problem try to use names that accurately represent the meaning or purpose of the variable.
